...
contract FundMe {
    ...
    constructor(address _priceFeedAdd) public {
        priceFeed = AggregatorV3Interface(_priceFeedAdd);
    ...
    function getVersion() public view returns (uint256) {
        // You will get the ETH TO USD address drom docs.chain link
        // If you use Mainnet then other address according to rinkeby their is another address
        // ETH TO USD address we placed inside it
        // https://docs.chain.link/docs/ethereum-addresses/ (get this address from there)

        // Like for Mainnet => 0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419
        // Like for Rinkeby => 0x8A753747A1Fa494EC906cE90E9f37563A8AF630e
    ...
    // What will be the get enterance fee according to the 20 Dollar
